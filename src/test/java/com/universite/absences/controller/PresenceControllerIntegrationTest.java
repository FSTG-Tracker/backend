...
public class PresenceControllerIntegrationTest extends BaseIntegrationTest {

    @Test
    void shouldRegisterPresenceIA() {
        // Setup
        ...
        etudiantReq.setEmail("etud-p@test.com");
        etudiantReq.setPassword("password123");
        etudiantReq.setCne("CNE-P");
        ...
        profReq.setNom("P");
        profReq.setPrenom("P");
        profReq.setEmail("prof3@test.com");
        ...
        PresenceIARequest presenceReq = PresenceIARequest.builder()
                .etudiantId(etuId.longValue())
                .seanceId(seanceId.longValue())
